...
const HamburgerMenu = ({ isOpen, user, onClose, onLogout, menuItems, location }) => {
  if (!isOpen) return null;

  // Add logout to menu items for mobile
  const mobileMenuItems = user 
    ? [...menuItems, { icon: <LogoutIcon />, label: "Logout", action: onLogout }]
    : [...menuItems, { icon: <KeyIcon />, label: "Login", path: "/login" }, { icon: <UserPlusIcon />, label: "Register", path: "/register" }];
  ...
  const getMenuItems = () => {
    if (!user) {
      return [
        ...
        { icon: <SearchIcon />, label: "Browse Properties", path: "/show-all-post" },
      ];
    }
    ...
    switch (user.role) {
      case "Admin":
        return [
          ...
          { icon: <BusinessIcon />, label: "Pending Landlords", path: "/admin/pending-landlords" },
          { icon: <ComputerIcon />, label: "Chat Dashboard", path: "/admin/AdminChatDashboard" },
          { icon: <DocumentIcon />, label: "Pending Properties", path: "/admin/landlord-applications" },
        ];
      
      case "Landlord":
        return [
          ...commonItems,
          { icon: <DashboardIcon />, label: "Dashboard", path: "/landlord/dashboard" },
          { icon: <BuildingIcon />, label: "My Properties", path: "/landlord/properties" },
          { icon: <ClipboardIcon />, label: "Proposals", path: "/landlord/proposals" },
      ...
      case "Tenant":
        return [
          ...commonItems,
          { icon: <DashboardIcon />, label: "Dashboard", path: "/tenant/dashboard" },
          { icon: <HeartIcon />, label: "Saved Posts", path: "/saved-posts" },
          { icon: <ChatIcon />, label: "Messages", path: "/messages" },
          { icon: <HistoryIcon />, label: "History", path: "/UserHistory" },
          { icon: <DocumentIcon />, label: "Your Applications", path: "/UserProperties" },
        ];
                ...
                >
                  <Link to="/saved-posts" className="dropdown-item">
                    ...
                    <div className="dropdown-item-content">
                      ...
                      <div className="dropdown-item-description">Your favorite properties</div>
                    </div>
                  </Link>
                  ...
                  <Link to="/messages" className="dropdown-item">
                    ...
                    <div className="dropdown-item-content">
                      ...
                      <div className="dropdown-item-description">Connect with others</div>
                    </div>
                  </Link>
                  ...
                  <Link to="/UserHistory" className="dropdown-item">
                    ...
                    <div className="dropdown-item-content">
                      ...
                      <div className="dropdown-item-description">Your activity timeline</div>
                    </div>
                  </Link>
                  ...
                  <Link to="/UserProperties" className="dropdown-item">
                    ...
                    <div className="dropdown-item-content">
                      <div className="dropdown-item-title">Your Applications</div>
                      <div className="dropdown-item-description">Track your applications</div>
                    </div>
                  </Link>
                </div>
              </div>
              ...
              <>
                <Link to="/" className="menu-card" onClick={closeMenu}>
                  ...
                  <div className="menu-card-content">
                    ...
                    <div className="menu-card-description">Discover amazing properties</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                <Link to="/show-all-post" className="menu-card" onClick={closeMenu}>
                  <div className="menu-card-icon">
                    <SearchIcon />
                  </div>
                  <div className="menu-card-content">
                    <div className="menu-card-title">Browse Properties</div>
                    <div className="menu-card-description">Explore all available listings</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>
                ...
                <Link to="/login" className="menu-card" onClick={closeMenu}>
                  ...
                  <div className="menu-card-content">
                    ...
                    <div className="menu-card-description">Access your account</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                <Link to="/register" className="menu-card primary" onClick={closeMenu}>
                  <div className="menu-card-icon">
                    <UserPlusIcon />
                  </div>
                  <div className="menu-card-content">
                    <div className="menu-card-title">Register</div>
                    <div className="menu-card-description">Join our community</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>
              </>
              ...
              <>
                ...
                >
                  ...
                  <div className="menu-card-content">
                    ...
                    <div className="menu-card-description">Your personal space</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>
                ...
                <Link to="/show-all-post" className="menu-card" onClick={closeMenu}>
                  ...
                  <div className="menu-card-content">
                    <div className="menu-card-title">Browse Properties</div>
                    <div className="menu-card-description">Find your perfect place</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                <Link to="/saved-posts" className="menu-card" onClick={closeMenu}>
                  <div className="menu-card-icon">
                    <HeartIcon />
                  </div>
                  <div className="menu-card-content">
                    <div className="menu-card-title">Saved Posts</div>
                    <div className="menu-card-description">Your favorite properties</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>
                ...
                <Link to="/messages" className="menu-card" onClick={closeMenu}>
                  ...
                  <div className="menu-card-content">
                    ...
                    <div className="menu-card-description">Connect with others</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                <Link to="/UserHistory" className="menu-card" onClick={closeMenu}>
                  <div className="menu-card-icon">
                    <HistoryIcon />
                  </div>
                  <div className="menu-card-content">
                    <div className="menu-card-title">History</div>
                    <div className="menu-card-description">Your activity timeline</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                <Link to="/UserProperties" className="menu-card" onClick={closeMenu}>
                  <div className="menu-card-icon">
                    <DocumentIcon />
                  </div>
                  <div className="menu-card-content">
                    <div className="menu-card-title">Your Applications</div>
                    <div className="menu-card-description">Track your applications</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </Link>

                {/* Dark Mode Toggle */}
                <div className="menu-card dark-mode-card" onClick={toggleDarkMode}>
                  ...
                  <div className="menu-card-content">
                    <div className="menu-card-title">{darkMode ? 'Light Mode' : 'Dark Mode'}</div>
                    <div className="menu-card-description">Switch to {darkMode ? 'light' : 'dark'} theme</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </div>
                ...
                <div className="menu-card logout-card" onClick={handleLogout}>
                  ...
                  <div className="menu-card-content">
                    ...
                    <div className="menu-card-description">Securely sign out</div>
                  </div>
                  <div className="menu-card-arrow">→</div>
                </div>
              </>
