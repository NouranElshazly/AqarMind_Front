    ...
    <div className="face-modal-overlay">
      <div className="face-modal-content">
        ...
        <div className="face-video-container">
          <div
            className={`face-video-ring ${
              isSuccessRef.current
                ? "face-video-ring-success"
                : "face-video-ring-scanning"
            }`}
          ></div>
        ...
        <div className="face-status-container">
          {error ? (
            <span className="face-status-badge face-status-error">{error}</span>
          ) : (
            <span
              className={`face-status-badge ${
                isSuccessRef.current
                  ? "face-status-success"
          ...
          <div className="login-brand-panel">
            ...
            <div className="login-brand-content">
              ...
              <p className="login-brand-description">
                Access your real estate dashboard and manage your properties
                with ease.
              </p>
