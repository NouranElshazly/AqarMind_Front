...
const FaceScanModal = ({ userData, onClose, onComplete }) => {
  ...
  useEffect(() => {
    const newSocket = io("https://localhost:44357", {
      ...
      <div className="face-scan-modal-content">
        ...
        <div className="face-scan-video-container">
          ...
          <div className="face-scan-video-wrapper">
            ...
            {!isComplete && !error && <div className="face-scan-line"></div>}

            {isComplete && (
              <div className="face-scan-success-overlay">
                <svg
                  className="face-scan-success-icon"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
...
const Register = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (errors.propertyDocument)
      setErrors((prev) => ({ ...prev, propertyDocument: "" }));
  };
  ...
  const validateForm = () => {
    ...
    if (!formData.password) {
      ...
      newErrors.password =
        "Must be 8+ characters, including uppercase, lowercase, number, and special character (@$!%*?&)";
    }
          ...
          <div className="register-brand-panel">
            ...
            <div className="register-brand-content">
              <div className="register-brand-icon">
                <svg
                  viewBox="0 0 24 24"
                  style={{ width: "3rem", height: "3rem", fill: "white" }}
                >
              ...
              <p className="register-brand-description">
                Create your account to access exclusive real estate
                opportunities and connect with property owners.
              </p>
            ...
            <form onSubmit={handleSubmit} className="register-form" noValidate>
              ...
              <div className="register-face-id">
                ...
                <label htmlFor="faceId" className="register-face-id-label">
                  <svg
                    className="register-face-id-icon"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
